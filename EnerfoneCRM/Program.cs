...
builder.Services.AddScoped<TarifaLuzService>();
builder.Services.AddScoped<TarifaGasService>();
builder.Services.AddScoped<TarifaTelefoniaService>();
builder.Services.AddScoped<TarifaAlarmaService>();
builder.Services.AddScoped<ServicioService>();
builder.Services.AddScoped<HistoricoCambioContratoService>();
builder.Services.AddScoped<ServicioGasService>();
