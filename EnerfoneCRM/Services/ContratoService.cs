    ...
    public class ContratoService
    {
        ...
        public async Task<List<Contrato>> ObtenerTodosPorTipoAsync(string tipo, string? rolUsuario = null, string? nombreUsuario = null, int? usuarioId = null)
        {
            ...
            var sql = @"
                SELECT 
                    c.id, 
                    COALESCE(c.id_contrato_externo, '') as id_contrato_externo,
                    ...
                    COALESCE(c.lineas_adicionales, '') as lineas_adicionales,
                    COALESCE(c.solo_fibra, '') as solo_fibra,
                    COALESCE(c.solo_movil, '') as solo_movil,
                    COALESCE(c.nombre_cliente, '') as nombre_cliente,
                    COALESCE(c.dni, '') as dni,
                    COALESCE(c.codigo_postal, '') as codigo_postal,
                    COALESCE(c.email, '') as email,
                    COALESCE(c.telefono, '') as telefono,
                    COALESCE(c.iban, '') as iban,
                    COALESCE(c.horario_contratacion, '') as horario_contratacion,
                    c.fecha_creacion,
                    COALESCE(c.en_Comercializadora, '') as en_Comercializadora,
                    COALESCE(c.en_CUPSGas, '') as en_CUPSGas,
                    c.fecha_modificacion,
                    c.comision,
                    COALESCE(c.pdf_contrato_url, '') as pdf_contrato_url,
                    c.idCliente,
                    COALESCE(c.TV, '') as TV,
                    COALESCE(c.LineaMovilPrincipal, '') as LineaMovilPrincipal,
                    COALESCE(c.TarifaLineaMovilPrincipal, '') as TarifaLineaMovilPrincipal,
                    COALESCE(c.TipoOperacion, '') as TipoOperacion,
                    COALESCE(c.Tarifa_tel, '') as Tarifa_tel,
                    c.tarifa_tel_id,
                    COALESCE(c.TipoTarifa_tel, '') as TipoTarifa_tel,
                    COALESCE(c.tipo_alarma, '') as tipo_alarma,
                    COALESCE(c.subtipo_inmueble, '') as subtipo_inmueble,
                    COALESCE(c.kit_alarma, '') as kit_alarma,
                    c.kit_alarma_id,
                    COALESCE(c.opcionales_alarma, '') as opcionales_alarma,
                    COALESCE(c.campana_alarma, '') as campana_alarma,
                    COALESCE(c.empresa_alarma, '') as empresa_alarma,
                    COALESCE(c.tipo_via_instalacion, '') as tipo_via_instalacion,
                    COALESCE(c.direccion_instalacion_alarma, '') as direccion_instalacion_alarma,
                    c.tiene_contrato_anterior,
                    COALESCE(c.numero_contrato_anterior, '') as numero_contrato_anterior,
                    COALESCE(c.compania_anterior, '') as compania_anterior,
                    c.fecha_permanencia_anterior,
                    c.usuario_comercializadora_id,
                    c.usuario_comercial_id,
                    c.servicio_id,
                    c.historico_liquidacion_id,
                    c.potencia_contratada_p1,
                    c.potencia_contratada_p2,
                    c.potencia_contratada_p3,
                    c.potencia_contratada_p4,
                    c.potencia_contratada_p5,
                    c.potencia_contratada_p6,
                    c.consumo_ultimos_12_meses,
                    c.consumo_anual_gas,
                    COALESCE(c.peaje_luz, '') as peaje_luz,
                    COALESCE(c.peaje_gas, '') as peaje_gas,
                    COALESCE(c.tipo_linea_movil_principal, '') as tipo_linea_movil_principal,
                    COALESCE(c.codigo_icc_principal, '') as codigo_icc_principal,
                    COALESCE(c.linea_movil_principal_2, '') as linea_movil_principal_2,
                    COALESCE(c.tipo_linea_movil_principal_2, '') as tipo_linea_movil_principal_2,
                    COALESCE(c.codigo_icc_principal_2, '') as codigo_icc_principal_2,
                    COALESCE(c.numero_instalacion, '') as numero_instalacion,
                    COALESCE(c.escalera_instalacion, '') as escalera_instalacion,
                    COALESCE(c.piso_instalacion, '') as piso_instalacion,
                    COALESCE(c.puerta_instalacion, '') as puerta_instalacion,
                    COALESCE(c.codigo_postal_instalacion, '') as codigo_postal_instalacion,
                    COALESCE(c.provincia_instalacion, '') as provincia_instalacion,
                    COALESCE(c.localidad_instalacion, '') as localidad_instalacion,
                    COALESCE(c.aclarador_instalacion, '') as aclarador_instalacion,
                    COALESCE(c.titular_iban_diferente, FALSE) as titular_iban_diferente,
                    COALESCE(c.titular_iban_dni, '') as titular_iban_dni,
                    COALESCE(c.titular_iban_nombre, '') as titular_iban_nombre,
                    COALESCE(c.titular_iban_numero, '') as titular_iban_numero,
                    c.fecha_activo,
                    c.fecha_alta,
                    COALESCE(c.operadora_tel, '') as operadora_tel,
                    COALESCE(c.fijo_tel, '') as fijo_tel,
                    COALESCE(c.tarifa_fibra_tel, '') as tarifa_fibra_tel,
                    c.numero_lineas_tel,
                    c.fecha_instalacion_tel,
                    COALESCE(c.horario_instalacion_tel, '') as horario_instalacion_tel,
                    COALESCE(c.telefono_linea1_tel, '') as telefono_linea1_tel,
                    COALESCE(c.tarifa_linea1_tel, '') as tarifa_linea1_tel,
                    COALESCE(c.tipo_linea1_tel, '') as tipo_linea1_tel,
                    COALESCE(c.codigo_icc_linea1_tel, '') as codigo_icc_linea1_tel,
                    COALESCE(c.telefono_linea2_tel, '') as telefono_linea2_tel,
                    COALESCE(c.tarifa_linea2_tel, '') as tarifa_linea2_tel,
                    COALESCE(c.tipo_linea2_tel, '') as tipo_linea2_tel,
                    COALESCE(c.codigo_icc_linea2_tel, '') as codigo_icc_linea2_tel,
                    COALESCE(c.telefono_linea3_tel, '') as telefono_linea3_tel,
                    COALESCE(c.tarifa_linea3_tel, '') as tarifa_linea3_tel,
                    COALESCE(c.tipo_linea3_tel, '') as tipo_linea3_tel,
                    COALESCE(c.codigo_icc_linea3_tel, '') as codigo_icc_linea3_tel,
                    COALESCE(c.telefono_linea4_tel, '') as telefono_linea4_tel,
                    COALESCE(c.tarifa_linea4_tel, '') as tarifa_linea4_tel,
                    COALESCE(c.tipo_linea4_tel, '') as tipo_linea4_tel,
                    COALESCE(c.codigo_icc_linea4_tel, '') as codigo_icc_linea4_tel,
                    COALESCE(c.telefono_linea5_tel, '') as telefono_linea5_tel,
                    COALESCE(c.tarifa_linea5_tel, '') as tarifa_linea5_tel,
                    COALESCE(c.tipo_linea5_tel, '') as tipo_linea5_tel,
                    COALESCE(c.codigo_icc_linea5_tel, '') as codigo_icc_linea5_tel,
                    COALESCE(c.telefono_linea6_tel, '') as telefono_linea6_tel,
                    COALESCE(c.tarifa_linea6_tel, '') as tarifa_linea6_tel,
                    COALESCE(c.tipo_linea6_tel, '') as tipo_linea6_tel,
                    COALESCE(c.codigo_icc_linea6_tel, '') as codigo_icc_linea6_tel,
                    COALESCE(c.telefono_linea7_tel, '') as telefono_linea7_tel,
                    COALESCE(c.tarifa_linea7_tel, '') as tarifa_linea7_tel,
                    COALESCE(c.tipo_linea7_tel, '') as tipo_linea7_tel,
                    COALESCE(c.codigo_icc_linea7_tel, '') as codigo_icc_linea7_tel,
                    COALESCE(c.telefono_linea8_tel, '') as telefono_linea8_tel,
                    COALESCE(c.tarifa_linea8_tel, '') as tarifa_linea8_tel,
                    COALESCE(c.tipo_linea8_tel, '') as tipo_linea8_tel,
                    COALESCE(c.codigo_icc_linea8_tel, '') as codigo_icc_linea8_tel,
                    COALESCE(c.telefono_linea9_tel, '') as telefono_linea9_tel,
                    COALESCE(c.tarifa_linea9_tel, '') as tarifa_linea9_tel,
                    COALESCE(c.tipo_linea9_tel, '') as tipo_linea9_tel,
                    COALESCE(c.codigo_icc_linea9_tel, '') as codigo_icc_linea9_tel,
                    COALESCE(c.telefono_linea10_tel, '') as telefono_linea10_tel,
                    COALESCE(c.tarifa_linea10_tel, '') as tarifa_linea10_tel,
                    COALESCE(c.tipo_linea10_tel, '') as tipo_linea10_tel,
                    COALESCE(c.codigo_icc_linea10_tel, '') as codigo_icc_linea10_tel,
                    COALESCE(c.telefono_linea11_tel, '') as telefono_linea11_tel,
                    COALESCE(c.tarifa_linea11_tel, '') as tarifa_linea11_tel,
                    COALESCE(c.tipo_linea11_tel, '') as tipo_linea11_tel,
                    COALESCE(c.codigo_icc_linea11_tel, '') as codigo_icc_linea11_tel,
                    COALESCE(c.telefono_linea12_tel, '') as telefono_linea12_tel,
                    COALESCE(c.tarifa_linea12_tel, '') as tarifa_linea12_tel,
                    COALESCE(c.tipo_linea12_tel, '') as tipo_linea12_tel,
                    COALESCE(c.codigo_icc_linea12_tel, '') as codigo_icc_linea12_tel,
                    COALESCE(c.telefono_linea13_tel, '') as telefono_linea13_tel,
                    COALESCE(c.tarifa_linea13_tel, '') as tarifa_linea13_tel,
                    COALESCE(c.tipo_linea13_tel, '') as tipo_linea13_tel,
                    COALESCE(c.codigo_icc_linea13_tel, '') as codigo_icc_linea13_tel,
                    COALESCE(c.telefono_linea14_tel, '') as telefono_linea14_tel,
                    COALESCE(c.tarifa_linea14_tel, '') as tarifa_linea14_tel,
                    COALESCE(c.tipo_linea14_tel, '') as tipo_linea14_tel,
                    COALESCE(c.codigo_icc_linea14_tel, '') as codigo_icc_linea14_tel,
                    COALESCE(c.telefono_linea15_tel, '') as telefono_linea15_tel,
                    COALESCE(c.tarifa_linea15_tel, '') as tarifa_linea15_tel,
                    COALESCE(c.tipo_linea15_tel, '') as tipo_linea15_tel,
                    COALESCE(c.codigo_icc_linea15_tel, '') as codigo_icc_linea15_tel,
                    COALESCE(c.alta_nueva_linea_principal, 0) as alta_nueva_linea_principal,
                    COALESCE(c.alta_nueva_linea_principal_2, 0) as alta_nueva_linea_principal_2,
                    COALESCE(c.alta_nueva_linea1_tel, 0) as alta_nueva_linea1_tel,
                    COALESCE(c.alta_nueva_linea2_tel, 0) as alta_nueva_linea2_tel,
                    COALESCE(c.alta_nueva_linea3_tel, 0) as alta_nueva_linea3_tel,
                    COALESCE(c.alta_nueva_linea4_tel, 0) as alta_nueva_linea4_tel,
                    COALESCE(c.alta_nueva_linea5_tel, 0) as alta_nueva_linea5_tel,
                    COALESCE(c.alta_nueva_linea6_tel, 0) as alta_nueva_linea6_tel,
                    COALESCE(c.alta_nueva_linea7_tel, 0) as alta_nueva_linea7_tel,
                    COALESCE(c.alta_nueva_linea8_tel, 0) as alta_nueva_linea8_tel,
                    COALESCE(c.alta_nueva_linea9_tel, 0) as alta_nueva_linea9_tel,
                    COALESCE(c.alta_nueva_linea10_tel, 0) as alta_nueva_linea10_tel,
                    COALESCE(c.alta_nueva_linea11_tel, 0) as alta_nueva_linea11_tel,
                    COALESCE(c.alta_nueva_linea12_tel, 0) as alta_nueva_linea12_tel,
                    COALESCE(c.alta_nueva_linea13_tel, 0) as alta_nueva_linea13_tel,
                    COALESCE(c.alta_nueva_linea14_tel, 0) as alta_nueva_linea14_tel,
                    COALESCE(c.alta_nueva_linea15_tel, 0) as alta_nueva_linea15_tel,
                    ...
                    COALESCE(c.observaciones_alarma, '') as observaciones_alarma,
                    COALESCE(c.observaciones_estado, '') as observaciones_estado,
                    COALESCE(c.direccion_segunda_residencia, '') as direccion_segunda_residencia,
                    COALESCE(c.tarifa_fibra_segunda_residencia, '') as tarifa_fibra_segunda_residencia,
                    COALESCE(c.cargado_en_plataforma, 0) as cargado_en_plataforma
                FROM contratos c
                LEFT JOIN usuarios u_comercial ON c.usuario_comercial_id = u_comercial.idusuarios";
            ...
            if (!string.IsNullOrEmpty(rolUsuario) && !string.IsNullOrEmpty(nombreUsuario))
            {
                ...
                {
                    whereConditions.Add($"u_comercial.username = {{{parameters.Count}}}");
                ...
                else if (rolUsuario == "Gestor" && usuarioId.HasValue)
                {
                    ...
                    var inConditions = string.Join(" OR ", nombresUsuarios.Select((_, i) => $"u_comercial.username = {{{parameters.Count + i}}}"));
            ...
            sql += " ORDER BY COALESCE(c.fecha_modificacion, c.fecha_creacion, '1900-01-01') DESC";
