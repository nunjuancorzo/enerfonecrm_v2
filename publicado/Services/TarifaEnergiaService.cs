...
namespace EnerfoneCRM.Services
{
    public class TarifaEnergiaService
    {
        ...
        {
            // NOTA: Se ha eliminado la normalización del nombre de empresa porque
            // causaba problemas con acrónimos (ej: "Endesa GC" se convertía en "Endesa Gc")
            // El nombre debe guardarse exactamente como está en el maestro de comercializadoras
