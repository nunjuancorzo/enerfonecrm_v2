// Excel-like paste functionality for bulk alarm contracts editing
let dotnetReference = null;

window.initializeContratosAlarmasPaste = function (dotnetRef) {
    console.log('Initializing Contratos Alarmas paste functionality');
    
    dotnetReference = dotnetRef;
    const table = document.getElementById('contratosAlarmasTable');
    if (!table) {
    ...
    console.log('Contratos Alarmas paste functionality initialized');
};
...
console.log('Contratos Alarmas paste functionality loaded');
