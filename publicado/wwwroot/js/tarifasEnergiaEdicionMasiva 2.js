// Excel-like paste functionality for bulk tarifas energia editing
let dotnetReference = null;

window.initializeExcelLikePaste = function (dotnetRef) {
    console.log('Initializing Excel-like paste functionality for tarifas energia');
    
    dotnetReference = dotnetRef;
    const table = document.getElementById('tarifasEnergiaTable');
    if (!table) {
    ...
    console.log('Excel-like functionality initialized for tarifas energia');
};
...
console.log('Excel-like functionality loaded for tarifas energia');
