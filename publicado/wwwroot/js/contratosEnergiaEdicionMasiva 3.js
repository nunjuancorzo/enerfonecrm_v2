// Excel-like paste functionality for bulk energy contracts editing
let dotnetReference = null;

window.initializeContratosEnergiaPaste = function (dotnetRef) {
    console.log('Initializing Contratos Energía paste functionality');
    
    dotnetReference = dotnetRef;
    const table = document.getElementById('contratosEnergiaTable');
    if (!table) {
    ...
    console.log('Contratos Energía paste functionality initialized');
};
...
console.log('Contratos Energía paste functionality loaded');
