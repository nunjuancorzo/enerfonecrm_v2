# ==============================================================================
# Script de publicación para ENERFONE CRM
# Destino: C:\enerfonecrm
# Base de datos: enerfone_pre
# ==============================================================================

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "PUBLICACIÓN ENERFONE CRM" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

# Configuración
$proyectoPath = ".\EnerfoneCRM\EnerfoneCRM.csproj"
$publishPath = ".\publicado"
$destinoProduccion = "C:\enerfonecrm"
$appSettingsProduccion = ".\appsettings.Production.Enerfone.json"
...
Write-Host "2. Configurando appsettings.Production.json para Enerfone..." -ForegroundColor Yellow
...
Write-Host "1. Detener el sitio en IIS (C:\enerfonecrm)" -ForegroundColor White
...
Write-Host "5. Verificar en https://enerfonecrm.com" -ForegroundColor White
Write-Host ""
