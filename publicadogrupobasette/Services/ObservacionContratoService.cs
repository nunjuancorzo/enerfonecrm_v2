...
namespace EnerfoneCRM.Services
{
    public class ObservacionContratoService
    {
        ...
        public async Task<bool> CrearAsync(ObservacionContrato observacion)
        {
            try
            {
                Console.WriteLine($"[ObservacionContratoService] Creando observación para contrato {observacion.IdContrato}");
                Console.WriteLine($"[ObservacionContratoService] Usuario: {observacion.Usuario}");
                ...
                Console.WriteLine($"[ObservacionContratoService] Filas afectadas: {resultado}");
                return true;
            }
            catch (Exception ex)
            {
                Console.WriteLine($"[ObservacionContratoService] ERROR: {ex.Message}");
                Console.WriteLine($"[ObservacionContratoService] StackTrace: {ex.StackTrace}");
                return false;
            }
        }
